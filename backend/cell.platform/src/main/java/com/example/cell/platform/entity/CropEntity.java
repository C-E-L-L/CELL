...
public class CropEntity extends BaseEntity {
    ...
    @Builder
    private CropEntity(Long id, TaskEntity task, String cropFilename, String bbox, CellType aiPrediction, Double aiConfidence, CellType finalLabel) {
        this.id = id;
        this.task = task;
    ...
    public static CropEntity of(Crop crop) {
